...
export async function generateMetadata({ params }) {
  try {
    ...
    return {
      ...
      alternates: { canonical: `https://idenwebstudio.online/novel/s/${params.slug}/${params.chapterSlug}` },
    };
  } catch {
...
export default async function ReadPage({ params }) {
  ...
  try {
    ...
    jsonLd = {
      ...
      url: `https://idenwebstudio.online/novel/s/${params.slug}/${params.chapterSlug}`,
  ...
  const breadcrumbLd = ssrNovel ? {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: `Chapter ${parseInt(String(params.chapterSlug).replace(/[^0-9]/g, '')) || 1}`, item: `https://idenwebstudio.online/novel/s/${params.slug}/${params.chapterSlug}` },
    ],
  } : null;
