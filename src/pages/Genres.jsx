...
const EMOJIS = { Action:'⚔️', Adventure:'🗺️', Comedy:'😂', Drama:'🎭', Fantasy:'🧙', Historical:'📜', Horror:'👻', Isekai:'🌀', 'Martial Arts':'🥋', Mecha:'🤖', Mystery:'🔍', Philosophical:'🤔', Romance:'💕', 'Sci-Fi':'🚀', System:'⚙️', Wuxia:'🐉', Xianxia:'☁️', Psychological:'🧠' };
...
export default function Genres() {
  ...
  useEffect(() => {
    // Fetch counts per genre in parallel
    Promise.all(
    ...
    <div style={{padding:'40px 0 80px', minHeight:'100vh'}}>
      <div className="container">
        ...
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fill, minmax(170px, 1fr))', gap:'16px'}}>
          {GENRES.map(g => (
            <Link key={g} to={`/browse?genre=${encodeURIComponent(g)}`} style={{textDecoration:'none'}}>
