  ...
  return (
    <div style={{padding:'40px 0 80px', minHeight:'100vh'}}>
      <div className="container">
        ...
        <p style={{color:'var(--text-muted)', fontFamily:'var(--font-mono)', fontSize:'0.82rem', marginBottom:'28px'}}>Top novels across NovaSphere</p>
        ...
        <div style={{display:'flex', flexDirection:'column', gap:'2px'}}>
          {loading
            ...
            : novels.map((n, i) => (
                <Link key={n._id} to={`/novel/${n._id}`} style={{textDecoration:'none'}}>
                  <div style={{
