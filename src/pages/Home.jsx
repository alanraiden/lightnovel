...
export default function Home() {
  ...
  return (
    <div className="home">
      <SEO
        title="Read Light Novels Online"
        description="Free light novels, web novels and translated fiction. Browse trending, top rated and newly added novels across fantasy, isekai, action, romance and more genres."
        url="/"
      />
      {/* ── SEO Hero Text ─────────────────────────────────────────────────── */}
        ...
        <div className="container seo-hero-inner">
          <div className="seo-hero-text">
            ...
            <p className="seo-hero-desc">
              Discover captivating Korean web novels, light novels, and manga translations.
              Immerse yourself in stories of romance, fantasy, action, and adventure.
            </p>
          </div>
